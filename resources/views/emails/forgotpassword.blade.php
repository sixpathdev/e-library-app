...
<body>
    ...
    <div class="container">
        <h3 class="center">
            <div style="display: flex;flex-direction:row;justify-content:center;align-items:center;">
                <span>
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="60" height="45" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 511.974 511.974" fill="#ffffff" xml:space="preserve">
    <g>
        <g>
            <g>
    ...
    <g>
                ...
                <span>Forgot password Mail</span>
            </div>
        </h3>
        <div style="margin-left: 20px">
            <p>Hello {{$name}},</p>
            <p>You are receiving this mail because you requested for a password reset. Please if this action was not
